public class UI{
  ...
  */
  public void display(int citySize){
    ...
    text("Day: " + dayCount, citySize  -150, citySize - 25);
    
    // Replace the number 0 with an expression that contains the variable citySize
    text("Current Infections: " + infected, citySize -250, citySize - 25);
    
    // Replace the number 0 with an expression that contains the variable citySize
    text("Recovered: " + recovered, citySize -375, citySize - 25);
    
    // Replace the number 0 with an expression that contains the variable citySize
    text("Dead: " + dead, citySize + -460, citySize - 25);
  }
}
